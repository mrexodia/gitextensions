...
namespace GitLabCiIntegration
{
    [MetadataAttribute]
    [AttributeUsage(AttributeTargets.Class)]
    public class GitLabCiIntegrationMetadata : BuildServerAdapterMetadataAttribute
    {
        public GitLabCiIntegrationMetadata(string buildServerType)
    ...
    [GitLabCiIntegrationMetadata(PluginName)]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    internal class GitLabCiAdapter : IBuildServerAdapter
    {
        public const string PluginName = "GitLab CI";
